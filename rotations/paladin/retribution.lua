...
local Combat = {
	...
	{'Execution Sentence','talent(1,2)&{player.area(6).enemies<=3&{spell(Judgment).cooldown<gcd*4.65||target.debuff(judgment).duration>gcd*4.65}&{!talent(7,2)||spell(Crusade).cooldown>gcd*2}}'},
	...
	{'Templar\'s Verdict', 'target.debuff(Judgment)&holypower>=5&{{talent(7,2)&!toggle(cooldowns)}||!talent(7,2)||spell(Crusade).cooldown>gcd*3}&{!talent(1,2)||spell(Execution Sentence).cooldown>gcd}'},
	...
	{'Judgment', 'target.debuff(Execution Sentence)&target.debuff(Execution Sentence).duration<gcd*2&target.debuff(Judgment).duration<gcd*2'},
	...
	{'Templar\'s Verdict', 'target.debuff(Judgment)&{holypower>=4||{{spell(Zeal).charges<=1.34||spell(Crusader Strike).charges<=1.34}&{spell(Divine Hammer).cooldown>gcd||spell(Blade of Justice).cooldown>gcd}}}&{{talent(7,2)&!toggle(cooldowns)}||!talent(7,2)||spell(Crusade).cooldown>gcd*4}&{!talent(1,2)||spell(Execution Sentence).cooldown>gcd*2}'},
